...
describe('ConfirmDialogComponent', () => {
	...
	beforeEach(async () => {
		...
		component.confirmDialogOptions = mockConfirmDialogOptions;
	...
	it('should valid value of message , title and text buttons in dialogConfirm', async () => {
		...
		expect(confirmButton.nativeElement.innerHTML.trim()).toEqual(
			mockConfirmDialogOptions.confirmButtonText
		);
		expect(cancelButton.nativeElement.innerHTML.trim()).toEqual(
